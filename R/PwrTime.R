...
#' The plot that was drawn is attached to that data frame as an attribute named `"plot"`, so that it
#' can be retrieved with `attr(result, "plot")` and passed to, for example, [ggplot2::ggsave()].
#' 
#' @references
